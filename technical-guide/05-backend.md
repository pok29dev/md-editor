...
- Semver 3 ส่วน เช่น `26.6.1101` (ปี 26, มิ.ย. 11, build 1) — patch = วัน×100+build; minor = เดือน (≤12, ปลอดภัยบน Windows MSI)
- ตรวจสอบ: `npm run validate:version` (`scripts/lib/version-format.mjs`)
- สเปก: `docs/VERSION-FORMAT.md`
